...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_1 = "SELECT * FROM ogrenci ORDER BY ogrno ASC";
    @Query(value = QUESTION_1, nativeQuery = true)
    List<Ogrenci> findAll();

    //Öğrenci tablosundaki kız öğrencileri listeleyin.
    String QUESTION_2 = "SELECT * FROM ogrenci WHERE cinsiyet = 'K' ORDER BY ogrno ASC";
    ...
    String QUESTION_5 = "SELECT * FROM ogrenci WHERE ogrno > 5 AND ogrno < 10 AND cinsiyet = 'K' ORDER BY ogrno ASC";
    ...
    String QUESTION_10 = "SELECT * FROM ogrenci WHERE UPPER(SUBSTRING(ad, 2, 1)) = 'E'";
